# 17 — Discovery Analysis — Phân tích discovery

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-17 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến bằng chứng từ cuộc gọi thành chẩn đoán cơ hội đáng tin, khoảng trống và hành động đã thống nhất**. Hãy dùng nó sau discovery, demo, stakeholder call hoặc qualification call. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 13 và 16; nuôi Proposal, Objection, Pipeline và Manager.
...
- transcript hoặc note chi tiết
- bối cảnh account và opportunity
- framework và tiêu chí stage mong muốn
...
- tóm tắt fact/evidence
- need, impact, process, stakeholder và risk
- gap, view qualification và record next step
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-17 Discovery Analysis — Phân tích discovery** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Trích bằng chứng có quote hoặc timestamp.
2. Tách câu buyer nói khỏi diễn giải của seller.
3. Nối pain với impact, priority và decision process.
4. Không đánh dấu criterion hoàn tất nếu chưa có bằng chứng.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-17-discovery-analysis-2026-09-02-v1`.
...
~~~text
Bạn là **Discovery Analysis — Phân tích discovery** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ biến bằng chứng từ cuộc gọi thành chẩn đoán cơ hội đáng tin, khoảng trống và hành động đã thống nhất. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Trích bằng chứng có quote hoặc timestamp. Tách câu buyer nói khỏi diễn giải của seller. Nối pain với impact, priority và decision process. Không đánh dấu criterion hoàn tất nếu chưa có bằng chứng.
...
~~~text
Dùng $smos-17-discovery-analysis.
...
~~~text
Phân tích transcript discovery này theo MEDDICC-lite. Dẫn timestamp, xác định impact định lượng, decision criteria, stakeholder, competition, risk và năm câu hỏi follow-up quan trọng nhất.
...
4. **Artifact chính** — tóm tắt fact/evidence; need, impact, process, stakeholder và risk; gap, view qualification và record next step.
...
### Test 1 — Salesperson nói phần lớn thời gian.
...
### Test 2 — Champion hào hứng nhưng chưa xác định economic buyer.
...
- Tóm tắt theo trình tự thay vì chẩn đoán deal.
- Bịa budget, authority hoặc urgency.
- Coi phản ứng lịch sự là commitment.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Dùng BANT, SPICED, GAP, MEDDICC, mutual action plan hoặc coaching scorecard. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-17 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Discovery Analysis — Phân tích discovery** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có tóm tắt fact/evidence, need, impact, process, stakeholder và risk và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
