# 14 — Outreach — Tiếp cận

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-14 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **viết outreach liên quan, ngắn và có đạo đức dựa trên lý do liên hệ đáng tin**. Hãy dùng nó cho cold email, LinkedIn, referral, event, partner hoặc first touch theo account. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 05, 06, 12 và 13; nuôi 15 và 19.
...
- lý do chọn angle
- first touch và các biến thể sequence
- bằng chứng cá nhân hóa và kiểm tra claim
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-14 Outreach — Tiếp cận** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-14-outreach-2026-09-02-v1`.
...
~~~text
Viết sequence cold email ba lần cho COO logistics sau tin mở rộng kho. Mỗi email dưới 90 từ, CTA xin phép, không nói như thể chúng ta biết vấn đề nội bộ của họ.
...
### Test 1 — Không có trigger ngoài việc công ty hợp ICP.
...
### Test 2 — Prospect nổi tiếng, nhận rất nhiều message.
...
- Cá nhân hóa giả như “rất thích website của anh/chị”.
- Nói chắc về pain chỉ được suy luận.
- Xin lịch 30 phút trước khi tạo hứng thú.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Tinh chỉnh cho email, LinkedIn, voice note, referral, event, ngôn ngữ hoặc enterprise formality. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-14 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Outreach — Tiếp cận** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có lý do chọn angle, first touch và các biến thể sequence và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
