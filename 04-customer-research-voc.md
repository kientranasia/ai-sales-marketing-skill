# 04 — Customer Research & VOC — Nghiên cứu khách hàng

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-04 · Lớp: Nền tảng · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến interview, review, ticket, survey và call thành ngôn ngữ khách hàng có thể truy vết và insight dùng được**. Hãy dùng nó trước khi làm messaging, offer, content, quyết định sản phẩm hoặc sales enablement. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 01 khi có; nuôi 05–11 và 19.
...
- chủ đề đã mã hóa và tần suất
- kho quote có source ID
- job, nỗi đau, mong muốn, objection và khoảng trống
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-04 Customer Research & VOC — Nghiên cứu khách hàng** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-04-customer-research-voc-2026-09-02-v1`.
...
~~~text
Dùng $smos-04-customer-research-voc.
...
~~~text
Phân tích 12 đoạn interview dưới đây theo nỗi đau, mong muốn, trigger mua hàng, objection và câu chữ nguyên văn. Không được bịa quote. Hãy cho thấy quan điểm thiểu số và câu hỏi chưa được trả lời.
...
### Test 1 — Ba interview mâu thuẫn mạnh với nhau.
...
### Test 2 — Dataset trộn review, sales note và support ticket.
...
- Viết lại câu chưa từng có rồi ghi như quote trực tiếp.
- Coi một anecdote lớn tiếng là theme chủ đạo.
- Trộn các phân khúc khiến insight trở nên chung chung.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Dùng JTBD, awareness stage, churn, win/loss hoặc mã hóa theo product discovery. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-04 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Customer Research & VOC — Nghiên cứu khách hàng** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có chủ đề đã mã hóa và tần suất, kho quote có source ID và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
