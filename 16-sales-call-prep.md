# 16 — Sales Call Prep — Chuẩn bị cuộc gọi sales

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-16 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **chuẩn bị call plan tập trung, có bằng chứng và giúp quyết định của buyer tiến lên**. Hãy dùng nó trước discovery, demo, meeting executive, renewal và negotiation. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 03, 05, 06 và 12–15; nuôi 17 và 19.
...
- call brief một trang
- giả thuyết, câu hỏi, agenda và vai trò
- kế hoạch proof, rủi ro và next step mong muốn
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-16 Sales Call Prep — Chuẩn bị cuộc gọi sales** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-16-sales-call-prep-2026-09-02-v1`.
...
~~~text
Chuẩn bị discovery call 30 phút với COO và IT manager của nhà phân phối 200 người. Dùng research dưới đây, tạo giả thuyết, bảy câu hỏi ưu tiên, agenda và exit criteria.
...
### Test 1 — Không biết vai trò attendee.
...
### Test 2 — Technical evaluator tham gia cuộc gọi business với executive.
...
- Chuẩn bị script thay vì conversation plan.
- Hỏi điều có thể tra từ nguồn công khai.
- Kết thúc mà không có next step hai bên đồng ý.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Điều chỉnh cho discovery, demo, technical validation, executive alignment, negotiation hoặc renewal. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-16 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Sales Call Prep — Chuẩn bị cuộc gọi sales** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có call brief một trang, giả thuyết, câu hỏi, agenda và vai trò và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
