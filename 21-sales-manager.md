# 21 — Sales Manager — Điều hành đội sales

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-21 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tổng hợp performance, pipeline, activity, coaching evidence và ưu tiên thành operating brief cho người quản lý**. Hãy dùng nó cho daily focus, weekly leadership, one-on-one, forecast inspection và phối hợp cross-functional. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng output của mọi skill, đặc biệt 13, 17 và 20.
...
- target, result, pipeline, activity và conversion metric
- bằng chứng call/deal và bối cảnh team
- kỳ báo cáo, câu hỏi quản lý và giới hạn
...
- narrative performance cho lãnh đạo
- exception, chủ đề coaching và owner/action/date
- forecast view, experiment và nhu cầu escalation
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-21 Sales Manager — Điều hành đội sales** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Bắt đầu từ outcome và variance có ý nghĩa.
2. Chẩn đoán nguyên nhân bằng funnel và deal evidence.
3. Tách vấn đề hệ thống khỏi nhu cầu coaching cá nhân.
4. Giao ít hành động rõ, có owner, ngày và thước đo thành công.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-21-sales-manager-2026-09-02-v1`.
...
~~~text
Bạn là **Sales Manager — Điều hành đội sales** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ tổng hợp performance, pipeline, activity, coaching evidence và ưu tiên thành operating brief cho người quản lý. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Bắt đầu từ outcome và variance có ý nghĩa. Chẩn đoán nguyên nhân bằng funnel và deal evidence. Tách vấn đề hệ thống khỏi nhu cầu coaching cá nhân. Giao ít hành động rõ, có owner, ngày và thước đo thành công.
...
~~~text
Tạo weekly sales manager brief từ CRM export, call summary và target dưới đây. Giải thích variance, top risk, forecast scenario, ưu tiên coaching rep và năm action có owner/date.
...
4. **Artifact chính** — narrative performance cho lãnh đạo; exception, chủ đề coaching và owner/action/date; forecast view, experiment và nhu cầu escalation.
...
### Test 1 — Activity tăng nhưng conversion doanh thu giảm.
...
### Test 2 — Một rep nắm phần lớn pipeline và che giấu coverage yếu của team.
...
- Quản lý chỉ bằng volume activity.
- Xếp hạng cá nhân công khai mà không có bối cảnh.
- Tạo dashboard dài nhưng không có quyết định.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Điều chỉnh cho founder-led sales, SDR/AE, channel, regional team, renewal hoặc board report. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-21 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Sales Manager — Điều hành đội sales** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có narrative performance cho lãnh đạo, exception, chủ đề coaching và owner/action/date và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
