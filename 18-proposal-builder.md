# 18 — Proposal Builder — Xây dựng proposal

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-18 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tạo proposal theo buyer, nối outcome đã chẩn đoán với scope, proof, economics và quyết định**. Hãy dùng nó sau discovery đủ sâu và trước commercial approval hoặc contracting. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 06, 16 và 17; nuôi 19–21.
...
- finding discovery đã xác thực
- offer, scope, giá, proof và giới hạn
- stakeholder, timeline và yêu cầu procurement
...
- narrative và executive summary
- scope, plan, trách nhiệm, investment và terms
- option, assumption, risk và trang next step
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-18 Proposal Builder — Xây dựng proposal** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Nhắc lại tình huống buyer bằng ngôn ngữ đã xác minh.
2. Nối từng deliverable với outcome hoặc risk bắt buộc.
3. Nêu rõ scope, trách nhiệm, assumption và loại trừ.
4. Đưa đường ra quyết định rõ, không bịa ROI.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-18-proposal-builder-2026-09-02-v1`.
...
~~~text
Bạn là **Proposal Builder — Xây dựng proposal** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ tạo proposal theo buyer, nối outcome đã chẩn đoán với scope, proof, economics và quyết định. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Nhắc lại tình huống buyer bằng ngôn ngữ đã xác minh. Nối từng deliverable với outcome hoặc risk bắt buộc. Nêu rõ scope, trách nhiệm, assumption và loại trừ. Đưa đường ra quyết định rõ, không bịa ROI.
...
~~~text
Tạo proposal cho pilot workflow sales AI sáu tuần dựa trên discovery evidence dưới đây. Gồm executive summary, success metric, scope, timeline, RACI, ba option, investment, assumption và next step.
...
4. **Artifact chính** — narrative và executive summary; scope, plan, trách nhiệm, investment và terms; option, assumption, risk và trang next step.
...
### Test 1 — Buyer đòi proposal khi discovery chưa hoàn tất.
...
### Test 2 — ROI quan trọng nhưng chưa có baseline.
...
- Gửi brochure năng lực chung chung.
- Bịa ROI định lượng.
- Để mơ hồ change request và trách nhiệm của khách hàng.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Điều chỉnh cho consulting, SaaS, RFP, pilot, retainer, implementation hoặc one-page executive. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-18 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Proposal Builder — Xây dựng proposal** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có narrative và executive summary, scope, plan, trách nhiệm, investment và terms và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
