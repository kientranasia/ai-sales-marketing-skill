# 01 — ICP Builder — Xây dựng ICP

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-01 · Lớp: Nền tảng · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến sản phẩm và bằng chứng khách hàng thành một Ideal Customer Profile hẹp, có thể kiểm chứng**. Hãy dùng nó trước khi chọn thị trường, lập kế hoạch nội dung, tìm lead hoặc thay đổi trọng tâm bán hàng. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Không có; nên là skill đầu tiên.
...
- thẻ ICP chính và phụ
- tiêu chí phù hợp và điều kiện loại trừ
- nhóm người mua, nỗi đau, trigger và khoảng trống bằng chứng
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-01 ICP Builder — Xây dựng ICP** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-01-icp-builder-2026-09-02-v1`.
...
~~~text
Hãy xây ICP cho một công ty tư vấn triển khai workflow AI giá 2.000 USD/tháng, phục vụ doanh nghiệp logistics 50–500 nhân viên tại Đông Nam Á. Hiện có ba khách hàng: forwarder, công ty vận hành kho và nhà phân phối. Chỉ hỏi câu hỏi thật sự cần thiết, sau đó tạo artifact theo chuẩn OS.
...
### Test 1 — Đầu vào rất ít: một dịch vụ B2B mới chưa có khách hàng.
...
### Test 2 — Bằng chứng mâu thuẫn: khách hàng lớn nhất có lợi nhuận tốt nhưng khó giữ chân.
...
- Viết ICP thành “bất kỳ doanh nghiệp nào muốn tăng trưởng”.
- Nhầm người dùng, champion, người mua và người phê duyệt.
- Coi giả định là sự thật đã được xác minh.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Thêm quy định ngành, tech stack tối thiểu, phong cách procurement hoặc quy tắc lãnh thổ. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-01 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **ICP Builder — Xây dựng ICP** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có thẻ ICP chính và phụ, tiêu chí phù hợp và điều kiện loại trừ và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
