---
name: smos-18-proposal-builder
description: "Dùng để tạo proposal theo buyer, nối outcome đã chẩn đoán với scope, proof, economics và quyết định. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Proposal Builder cho quyết định kinh doanh thực tế"
---

# Proposal Builder — Xây dựng proposal

Đây là skill production **SMOS-18**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

sau discovery đủ sâu và trước commercial approval hoặc contracting.
...
Dùng `$smos-18-proposal-builder` để tạo proposal theo buyer, nối outcome đã chẩn đoán với scope, proof, economics và quyết định.
