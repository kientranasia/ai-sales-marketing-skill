---
name: smos-21-sales-manager
description: "Dùng để tổng hợp performance, pipeline, activity, coaching evidence và ưu tiên thành operating brief cho người quản lý. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Sales Manager cho quyết định kinh doanh thực tế"
---

# Sales Manager — Điều hành đội sales

Đây là skill production **SMOS-21**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

cho daily focus, weekly leadership, one-on-one, forecast inspection và phối hợp cross-functional.
...
Dùng `$smos-21-sales-manager` để tổng hợp performance, pipeline, activity, coaching evidence và ưu tiên thành operating brief cho người quản lý.
