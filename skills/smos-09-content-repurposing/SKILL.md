---
name: smos-09-content-repurposing
description: "Dùng để biến một tài sản nguồn thành nhiều mảnh nội dung native theo channel mà vẫn giữ nghĩa và attribution. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Content Repurposing cho quyết định kinh doanh thực tế"
---

# Content Repurposing — Tái sử dụng nội dung

Đây là skill production **SMOS-09**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

sau webinar, interview, article, podcast, report hoặc sales call có insight tái dùng.
...
Dùng `$smos-09-content-repurposing` để biến một tài sản nguồn thành nhiều mảnh nội dung native theo channel mà vẫn giữ nghĩa và attribution.
