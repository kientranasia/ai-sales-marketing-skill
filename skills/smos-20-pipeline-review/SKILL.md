---
name: smos-20-pipeline-review
description: "Dùng để biến dữ liệu opportunity thành forecast, risk view và danh sách hành động có thứ tự ưu tiên dựa trên bằng chứng. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Pipeline Review cho quyết định kinh doanh thực tế"
---

# Pipeline Review — Rà soát pipeline

Đây là skill production **SMOS-20**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

cho review tuần, forecast call, coaching rep và vệ sinh pipeline.
...
Dùng `$smos-20-pipeline-review` để biến dữ liệu opportunity thành forecast, risk view và danh sách hành động có thứ tự ưu tiên dựa trên bằng chứng.
