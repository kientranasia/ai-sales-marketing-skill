---
name: smos-02-market-research
description: "Dùng để tạo market brief định hướng quyết định, gồm dữ kiện có nguồn, ước tính, xu hướng và hàm ý chiến lược. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Market Research cho quyết định kinh doanh thực tế"
---

# Market Research — Nghiên cứu thị trường

Đây là skill production **SMOS-02**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

khi vào một category mới, đánh giá phân khúc, lập kế hoạch hoặc kiểm tra nhu cầu.
...
Dùng `$smos-02-market-research` để tạo market brief định hướng quyết định, gồm dữ kiện có nguồn, ước tính, xu hướng và hàm ý chiến lược.
