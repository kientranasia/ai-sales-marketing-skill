---
name: smos-08-content-creator
description: "Dùng để tạo nội dung đúng channel, chính xác và thuyết phục từ một brief đã được duyệt. Áp dụng trong AI Sales & Marketing OS khi workflow này phù hợp."
metadata:
  short-description: "Content Creator cho quyết định kinh doanh thực tế"
---

# Content Creator — Sáng tạo nội dung

Đây là skill production **SMOS-08**. Skill này chạy trong project công ty có Business Context Card và artifact bằng chứng có version.

## Khi gọi skill

cho post, email, article, landing page, script và thought leadership.
...
Dùng `$smos-08-content-creator` để tạo nội dung đúng channel, chính xác và thuyết phục từ một brief đã được duyệt.
