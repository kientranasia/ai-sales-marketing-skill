# 02 — Market Research — Nghiên cứu thị trường

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-02 · Lớp: Nền tảng · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tạo market brief định hướng quyết định, gồm dữ kiện có nguồn, ước tính, xu hướng và hàm ý chiến lược**. Hãy dùng nó khi vào một category mới, đánh giá phân khúc, lập kế hoạch hoặc kiểm tra nhu cầu. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 01 khi có; bàn giao cho Positioning, Offer và Campaign.
...
- định nghĩa thị trường và địa lý
- quyết định cần đưa ra và khoảng thời gian
- nguồn đã biết, giới hạn và artifact ICP nếu có
...
- bản đồ thị trường và động lực
- bảng bằng chứng kèm độ tin cậy
- cơ hội, rủi ro và bước nghiên cứu tiếp theo
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-02 Market Research — Nghiên cứu thị trường** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Chốt ranh giới thị trường trước khi ước tính.
2. Tách dữ kiện có nguồn, phép tính và giả thuyết.
3. Đối chiếu các tuyên bố quan trọng và ghi ngày nguồn.
4. Chuyển phát hiện thành quyết định và bước kiểm chứng có thể bác bỏ.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-02-market-research-2026-09-02-v1`.
...
~~~text
Bạn là **Market Research — Nghiên cứu thị trường** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ tạo market brief định hướng quyết định, gồm dữ kiện có nguồn, ước tính, xu hướng và hàm ý chiến lược. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Chốt ranh giới thị trường trước khi ước tính. Tách dữ kiện có nguồn, phép tính và giả thuyết. Đối chiếu các tuyên bố quan trọng và ghi ngày nguồn. Chuyển phát hiện thành quyết định và bước kiểm chứng có thể bác bỏ.
...
~~~text
Nghiên cứu thị trường tự động hóa kho tại Việt Nam để quyết định go-to-market trong 12 tháng. Nếu có web, hãy dùng web và dẫn nguồn; đánh dấu mọi ước tính; kết thúc bằng ba điều kiện go/no-go.
...
4. **Artifact chính** — bản đồ thị trường và động lực; bảng bằng chứng kèm độ tin cậy; cơ hội, rủi ro và bước nghiên cứu tiếp theo.
...
### Test 1 — Chế độ không dùng web, chỉ dùng một báo cáo ngành được dán vào.
...
### Test 2 — Category mơ hồ, trong đó cách định nghĩa làm thay đổi quy mô thị trường.
...
- Bịa số TAM hoặc citation.
- Kể xu hướng nhưng không nói tác động kinh doanh.
- Dùng dữ kiện cũ mà không ghi ngày.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Chọn độ sâu TAM/SAM/SOM, category design, quy định, khu vực hoặc lập kịch bản. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-02 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Market Research — Nghiên cứu thị trường** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có bản đồ thị trường và động lực, bảng bằng chứng kèm độ tin cậy và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
