# 12 — Lead Research — Nghiên cứu lead

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-12 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tạo account/contact brief ngắn, có bằng chứng để cá nhân hóa một cách liên quan**. Hãy dùng nó trước outreach, call, account planning hoặc ưu tiên lead. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 01, 05 và 06; nuôi 13–16.
...
- định danh company/contact
- artifact ICP và offer
- phạm vi, khu vực và khoảng thời gian nghiên cứu
...
- fact về account và source log
- trigger, giả thuyết pain và stakeholder map
- góc cá nhân hóa và câu hỏi chưa trả lời
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-12 Lead Research — Nghiên cứu lead** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Xác minh đúng danh tính trước khi nghiên cứu.
2. Chỉ ghi fact liên quan, có ngày và nguồn.
3. Tách quan sát khỏi giả thuyết pain.
4. Tránh suy luận nhạy cảm về cá nhân và giả vờ thân quen.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-12-lead-research-2026-09-02-v1`.
...
~~~text
Bạn là **Lead Research — Nghiên cứu lead** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ tạo account/contact brief ngắn, có bằng chứng để cá nhân hóa một cách liên quan. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Xác minh đúng danh tính trước khi nghiên cứu. Chỉ ghi fact liên quan, có ngày và nguồn. Tách quan sát khỏi giả thuyết pain. Tránh suy luận nhạy cảm về cá nhân và giả vờ thân quen.
...
~~~text
Nghiên cứu ACME Logistics cho offer workflow AI. Tìm trigger vận hành gần đây, stakeholder có khả năng liên quan và ba góc outreach có nguồn. Dẫn nguồn và đánh dấu giả thuyết.
...
4. **Artifact chính** — fact về account và source log; trigger, giả thuyết pain và stakeholder map; góc cá nhân hóa và câu hỏi chưa trả lời.
...
### Test 2 — Không thấy trigger công khai đáng kể nào gần đây.
...
- Coi giả định từ job title là fact.
- Đưa chi tiết cá nhân không liên quan vào message.
- Tạo dossier dài nhưng không có angle dùng được.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Thêm tier account, territory, technology signal, hiring signal, news hoặc CRM context. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-12 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Lead Research — Nghiên cứu lead** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có fact về account và source log, trigger, giả thuyết pain và stakeholder map và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
