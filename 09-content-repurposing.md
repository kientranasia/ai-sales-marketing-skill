# 09 — Content Repurposing — Tái sử dụng nội dung

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-09 · Lớp: Tạo nhu cầu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến một tài sản nguồn thành nhiều mảnh nội dung native theo channel mà vẫn giữ nghĩa và attribution**. Hãy dùng nó sau webinar, interview, article, podcast, report hoặc sales call có insight tái dùng. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 05, 07 và 08; nuôi Campaign.
...
- nội dung nguồn đã duyệt
- channel và audience mục tiêu
- số lượng, format và CTA mong muốn
...
- bản đồ insight nguồn
- ma trận repurpose
- asset có thể chỉnh sửa và truy vết
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-09 Content Repurposing — Tái sử dụng nội dung** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Tách claim, story, ví dụ và quote thành các đơn vị nhỏ.
2. Ghép insight với format và awareness stage phù hợp.
3. Viết lại cho channel thay vì chỉ rút ngắn.
4. Truy ngược mọi claim/quote về nguồn.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-09-content-repurposing-2026-09-02-v1`.
...
~~~text
Bạn là **Content Repurposing — Tái sử dụng nội dung** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ biến một tài sản nguồn thành nhiều mảnh nội dung native theo channel mà vẫn giữ nghĩa và attribution. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Tách claim, story, ví dụ và quote thành các đơn vị nhỏ. Ghép insight với format và awareness stage phù hợp. Viết lại cho channel thay vì chỉ rút ngắn. Truy ngược mọi claim/quote về nguồn.
...
~~~text
Dùng $smos-09-content-repurposing.
...
~~~text
Biến transcript webinar 30 phút thành năm LinkedIn post, một email, một outline carousel và ba script video ngắn. Tránh lặp ý và gắn timestamp nguồn cho từng asset.
...
4. **Artifact chính** — bản đồ insight nguồn; ma trận repurpose; asset có thể chỉnh sửa và truy vết.
...
### Test 1 — Nguồn chỉ có hai insight thật sự hữu ích.
...
### Test 2 — Transcript có lỗi lời nói và số liệu chưa chắc chắn.
...
- Tạo 10 bản tóm tắt gần như giống nhau.
- Cắt ngữ cảnh đến mức claim gây hiểu lầm.
- Dùng quote transcript chưa được xác minh.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Định nghĩa tỷ lệ channel, founder voice, localization và quy tắc evergreen/update. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-09 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Content Repurposing — Tái sử dụng nội dung** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có bản đồ insight nguồn, ma trận repurpose và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
