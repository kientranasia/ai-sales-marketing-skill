# 08 — Content Creator — Sáng tạo nội dung

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-08 · Lớp: Tạo nhu cầu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tạo nội dung đúng channel, chính xác và thuyết phục từ một brief đã được duyệt**. Hãy dùng nó cho post, email, article, landing page, script và thought leadership. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 04, 05 và 07; nuôi 09–10.
...
- content brief và hành động mong muốn
- messaging, VOC, proof và nguồn
- channel, format, voice, độ dài và giới hạn
...
- các angle và lý do chọn
- bản nháp hoàn chỉnh kèm CTA
- kiểm tra fact/claim và ghi chú revision
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-08 Content Creator — Sáng tạo nội dung** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Phân tích audience, awareness và mục tiêu.
2. Chọn framework phù hợp và một angle chính.
3. Viết theo ngôn ngữ native của channel và brand voice.
4. Audit claim, độ cụ thể, khả năng đọc và CTA.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-08-content-creator-2026-09-02-v1`.
...
~~~text
Bạn là **Content Creator — Sáng tạo nội dung** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ tạo nội dung đúng channel, chính xác và thuyết phục từ một brief đã được duyệt. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Phân tích audience, awareness và mục tiêu. Chọn framework phù hợp và một angle chính. Viết theo ngôn ngữ native của channel và brand voice. Audit claim, độ cụ thể, khả năng đọc và CTA.
...
~~~text
Viết LinkedIn post 220 từ cho COO logistics về lý do pilot AI thường dừng sau demo. Dùng PAS nhẹ, thêm một chẩn đoán thực hành, tránh hype và mời audit workflow.
...
4. **Artifact chính** — các angle và lý do chọn; bản nháp hoàn chỉnh kèm CTA; kiểm tra fact/claim và ghi chú revision.
...
### Test 1 — Brief không có proof cho một claim mạnh.
...
### Test 2 — Cùng một ý tưởng nhưng cần viết cho expert và beginner.
...
- Ép công thức copy vào mọi format.
- Dùng ngôn ngữ AI chung chung không có ví dụ.
- Bịa statistic, testimonial hoặc kết quả khách hàng.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Đặt brand voice, phrase cấm, tỷ lệ Việt/Anh, compliance và template từng channel. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-08 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Content Creator — Sáng tạo nội dung** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có các angle và lý do chọn, bản nháp hoàn chỉnh kèm CTA và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
