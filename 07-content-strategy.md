# 07 — Content Strategy — Chiến lược nội dung

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-07 · Lớp: Tạo nhu cầu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến mục tiêu kinh doanh, insight ICP và offer thành hệ thống biên tập tập trung**. Hãy dùng nó trước khi làm content calendar hoặc khi xuất bản thiếu đều đặn và không nối với doanh thu. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 01, 04–06; nuôi 08–10.
...
- content thesis, pillar và hành trình audience
- vai trò channel và luật biên tập
- roadmap 90 ngày, thước đo và vòng lặp học hỏi
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-07 Content Strategy — Chiến lược nội dung** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-07-content-strategy-2026-09-02-v1`.
...
~~~text
Xây chiến lược 90 ngày cho LinkedIn và newsletter, nhắm COO ngành logistics. Team có tám giờ/tuần. Nối từng pillar với offer và định nghĩa leading indicator.
...
### Test 1 — Founder có expertise nhưng không có case study.
...
### Test 2 — Hai channel tranh giành nguồn lực sản xuất.
...
- Gọi danh sách topic là strategy.
- Tối ưu reach nhưng không có đường conversion.
- Chọn nhiều channel hơn khả năng duy trì.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Điều chỉnh cho founder-led, SEO, account-based, community, partner hoặc product-led content. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-07 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Content Strategy — Chiến lược nội dung** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có content thesis, pillar và hành trình audience, vai trò channel và luật biên tập và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
