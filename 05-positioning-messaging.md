# 05 — Positioning & Messaging — Định vị và thông điệp

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-05 · Lớp: Chiến lược · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **tạo hệ thống messaging khác biệt, có bằng chứng và phù hợp với một ICP cùng bối cảnh mua**. Hãy dùng nó khi công ty nói quá chung chung, ra offer mới hoặc cần ngôn ngữ nhất quán giữa marketing và sales. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Tốt nhất sau 01, 03 và 04; nuôi mọi skill content và sales.
...
- message hierarchy và proof map
- headline, pitch và biến thể theo vai trò
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-05 Positioning & Messaging — Định vị và thông điệp** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-05-positioning-messaging-2026-09-02-v1`.
...
~~~text
Dùng $smos-05-positioning-messaging.
...
~~~text
Tạo positioning cho công ty tư vấn workflow AI phục vụ COO ngành logistics. Dùng ICP, VOC và ghi chú đối thủ dưới đây. Cho một core position, message house, khoảng trống proof và biến thể cho CEO, COO, IT.
...
### Test 1 — Sản phẩm mạnh nhưng chưa có case study định lượng.
...
### Test 2 — Hai vai trò người mua coi trọng hai outcome khác nhau.
...
- Dùng “đổi mới, liền mạch, dẫn đầu” làm khác biệt.
- Nêu feature trước outcome.
- Đổi promise cốt lõi giữa các channel.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Dùng category creation, StoryBrand, value proposition canvas hoặc chuẩn proof enterprise. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-05 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Positioning & Messaging — Định vị và thông điệp** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có positioning statement, message hierarchy và proof map và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
