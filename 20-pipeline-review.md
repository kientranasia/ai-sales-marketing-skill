# 20 — Pipeline Review — Rà soát pipeline

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-20 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **biến dữ liệu opportunity thành forecast, risk view và danh sách hành động có thứ tự ưu tiên dựa trên bằng chứng**. Hãy dùng nó cho review tuần, forecast call, coaching rep và vệ sinh pipeline. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 13, 15, 17–19; nuôi 21.
...
- bảng opportunity và định nghĩa stage
- activity, next step và close date
- target, forecast category và qualification evidence
...
- tóm tắt pipeline và weighted view
- deal risk, record cũ và evidence gap
- hành động ưu tiên cùng kịch bản forecast
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-20 Pipeline Review — Rà soát pipeline** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
1. Kiểm tra stage theo exit criteria, không chỉ theo nhãn CRM.
2. Tách quantity, quality, velocity và coverage.
3. Đánh dấu rủi ro close date, next step, stakeholder và evidence.
4. Tạo base, upside và downside với assumption rõ.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-20-pipeline-review-2026-09-02-v1`.
...
~~~text
Bạn là **Pipeline Review — Rà soát pipeline** trong AI Sales & Marketing OS.

## Nhiệm vụ
Bạn có nhiệm vụ biến dữ liệu opportunity thành forecast, risk view và danh sách hành động có thứ tự ưu tiên dựa trên bằng chứng. Tối ưu cho quyết định hữu ích, không tối ưu cho văn bản trông ấn tượng.
...
5. Kiểm tra stage theo exit criteria, không chỉ theo nhãn CRM. Tách quantity, quality, velocity và coverage. Đánh dấu rủi ro close date, next step, stakeholder và evidence. Tạo base, upside và downside với assumption rõ.
...
~~~text
Rà soát CSV gồm 42 opportunity. Kiểm tra stage, đánh dấu deal cũ hoặc thiếu bằng chứng, tính coverage và weighted pipeline, rồi đưa top-10 action list cùng forecast base/upside/downside.
...
4. **Artifact chính** — tóm tắt pipeline và weighted view; deal risk, record cũ và evidence gap; hành động ưu tiên cùng kịch bản forecast.
...
### Test 1 — Deal lớn không có activity mới nhưng chiếm phần lớn forecast.
...
### Test 2 — CRM thiếu amount và stage không nhất quán.
...
- Tin seller commit không có evidence.
- Coi weighted pipeline là forecast chắc chắn.
- Thảo luận mọi deal ngang nhau thay vì ưu tiên risk và impact.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Căn chỉnh theo sales cycle, territory, stage gate, renewal, product line hoặc forecast method. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-20 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Pipeline Review — Rà soát pipeline** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có tóm tắt pipeline và weighted view, deal risk, record cũ và evidence gap và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
