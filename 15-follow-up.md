# 15 — Follow-up — Theo đuổi cơ hội

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-15 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **chọn và viết follow-up tốt nhất dựa trên trạng thái hội thoại, giá trị, thời điểm và sự đồng thuận**. Hãy dùng nó sau outreach, meeting, proposal, giai đoạn không phản hồi hoặc deal đình trệ. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 10, 11 và 14; nuôi Pipeline và Sales Manager.
...
- hành động và thời điểm đề xuất
- message cùng luật dừng/escalate
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-15 Follow-up — Theo đuổi cơ hội** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-15-follow-up-2026-09-02-v1`.
...
~~~text
Dựa trên email thread và meeting note này, đề xuất follow-up tiếp theo. Đã gửi pricing chín ngày trước và buyer nói legal sẽ review. Viết một message ngắn và lịch stop/escalate.
...
### Test 1 — Prospect nói “quý này chưa phù hợp”.
...
### Test 2 — Năm touch không phản hồi và không có giá trị mới.
...
- Gửi “just checking in”.
- Bỏ qua ngày đã hứa hoặc concern của buyer.
- Tự động liên hệ vô hạn mà không có stop rule.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Tạo sequence sau demo, proposal, event, renewal, no-show, nurture hoặc breakup. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-15 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Follow-up — Theo đuổi cơ hội** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có chẩn đoán trạng thái, hành động và thời điểm đề xuất và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
