...
> OS ID: SMOS-19 · Lớp: Vận hành doanh thu · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **chẩn đoán mối lo đằng sau objection và phản hồi bằng đồng cảm, bằng chứng cùng bước tiếp theo phù hợp**. Hãy dùng nó trong outreach, discovery, demo, review proposal, negotiation và renewal. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 03–06 và 17–18; nuôi Pipeline và Manager.
...
- chẩn đoán objection và độ tin cậy
- các phương án phản hồi và câu hỏi
- proof cần có, ranh giới concession và next action
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-19 Objection Handling — Xử lý phản đối** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-19-objection-handling-2026-09-02-v1`.
...
~~~text
Dùng $smos-19-objection-handling.
...
~~~text
Xử lý câu “Giải pháp của bạn đắt quá; chúng tôi có thể tự xây”. Đưa một câu hỏi chẩn đoán, câu trả lời ngắn, khung so sánh, proof cần dùng và điều không nên nói. Không tự động giảm giá.
...
### Test 1 — Concern về security mà seller chưa trả lời được.
...
### Test 2 — “Cứ gửi thông tin” có thể chỉ là lời từ chối lịch sự.
...
- Tranh luận trước khi hiểu objection.
- Dùng pressure hoặc scarcity giả.
- Giảm giá khi vấn đề thật là risk hoặc priority.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Tạo thư viện cho price, timing, trust, security, integration, build-vs-buy, competitor hoặc procurement. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-19 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Objection Handling — Xử lý phản đối** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có chẩn đoán objection và độ tin cậy, các phương án phản hồi và câu hỏi và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
