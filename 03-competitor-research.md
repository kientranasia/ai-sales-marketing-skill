# 03 — Competitor Research — Nghiên cứu đối thủ

> **AI cho Sales & Marketing — Hệ thống AI thực dụng cho doanh nghiệp tăng trưởng**  
> OS ID: SMOS-03 · Lớp: Nền tảng · Phiên bản: 1.0

## Skill này dùng để làm gì?

Skill này giúp bạn **so sánh các lựa chọn thật, kể cả status quo, mà không bịa thông tin về đối thủ**. Hãy dùng nó cho positioning, battlecard, chuẩn bị sales call và chiến lược sản phẩm. Có thể chạy hoàn toàn trong một cuộc trò chuyện ChatGPT; web, file, app, CRM hoặc automation chỉ là phần mở rộng tùy chọn.

**Kết nối trong OS:** Dùng 01–02; bàn giao cho 05, 16 và 19.
...
- bản đồ lựa chọn thay thế
- ma trận so sánh có bằng chứng
- claim cho battlecard, cách phản hồi và khoảng trống nghiên cứu
...
3. Nếu workspace hỗ trợ reusable skill, tạo skill có tên **SMOS-03 Competitor Research — Nghiên cứu đối thủ** và dán phần “System / Skill Instructions” bên dưới vào main instructions.
...
Kiểm tra Quality Checklist. Sửa fact, chấp nhận hoặc từ chối khuyến nghị, rồi yêu cầu Handoff Packet ngắn. Lưu artifact với ngày và phiên bản, ví dụ: `SMOS-03-competitor-research-2026-09-02-v1`.
...
~~~text
Dùng $smos-03-competitor-research.
...
~~~text
So sánh công ty tư vấn enablement sales bằng AI của chúng tôi với agency, SaaS tool, tuyển người nội bộ và phương án không làm gì cho một công ty B2B 100 người. Tạo battlecard và đánh dấu mọi claim chưa kiểm chứng.
...
### Test 1 — Đối thủ có rất ít thông tin công khai.
...
### Test 2 — Sản phẩm rẻ hơn nhưng yếu hơn về hỗ trợ triển khai.
...
- Tạo feature dump thay vì tiêu chí mua.
- Bỏ qua status quo và phương án tự xây.
- Viết claim sales không thể chứng minh.
- Gộp nhiều quyết định không liên quan vào một lần chạy.
- Tin văn phong trôi chảy của AI mà không review trước khi dùng.

## Tùy chỉnh

Thêm win/loss, giá, security, triển khai hoặc tiêu chí theo khu vực. Hãy giữ nguyên luật bằng chứng và footer OS để các skill tương thích với nhau. Đưa ví dụ, policy và dữ liệu công ty vào file project thay vì hard-code fact tạm thời trong instructions.
...
3. **Bối cảnh (45 giây):** giải thích vị trí SMOS-03 trong OS và nó nhận gì.
...
“Trong tutorial này, chúng ta xây **Competitor Research — Nghiên cứu đối thủ** bên trong một AI Sales & Marketing OS thực dụng. Sau video, bạn sẽ có bản đồ lựa chọn thay thế, ma trận so sánh có bằng chứng và một handoff dùng được cho workflow tiếp theo. Toàn bộ bài có thể làm trong ChatGPT; integration chỉ là tùy chọn.”
